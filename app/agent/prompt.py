...
- "compare": two periods. "period" is the earlier one, "compare_period" the later one (or "previous_period" for "vs the month before").
...
REPAIR_TEMPLATE = "Your JSON was invalid: {error}\nReturn the corrected JSON object only."


def repair_message(error: str) -> HumanMessage:
    return HumanMessage(content=REPAIR_TEMPLATE.format(error=error[:600]))
